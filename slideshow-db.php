    ...
    <body>
        ...
        <div id="leftPane">            
            <div id="slideshowOptions">
                <fieldset>
                    <legend class="title">
                        <span><a class="show_collapse" title="Slideshow Options" onclick="toggleOptionsPane(this);">&laquo;&laquo;&laquo;</a></span>    
        ...
        <div id="rightPane">
            <div id="slideInfo">
                <fieldset>
                    <legend class="title">
                        <span><a class="info_collapse" title="Slide Information" onclick="toggleInfoPane(this);">&laquo;&laquo;&laquo;</a></span>
